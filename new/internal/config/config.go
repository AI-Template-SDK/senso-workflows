...
func Load() *Config {
	...
	if err != nil {
		...
		dbConfig = DatabaseConfig{
			...
			MaxOpenConns:    getEnvInt("DB_MAX_OPEN_CONNS", 100), // Increased for Step Functions concurrency
			MaxIdleConns:    getEnvInt("DB_MAX_IDLE_CONNS", 50),  // Increased for Step Functions concurrency
